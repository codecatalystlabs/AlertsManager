...
/**
 * Dense table primitives. Row height lives HERE (and in whatever the tallest
 * cell renders), so keep inline controls small — a single `h-8` button in one
 * column sets the height of every row in the table.
 */
