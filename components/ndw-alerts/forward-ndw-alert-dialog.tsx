...
interface ForwardNdwAlertDialogProps {
	isOpen: boolean;
	onClose: () => void;
	/** What is being forwarded, e.g. "eCHIS signal" or "POE alert". */
	sourceLabel: string;
	/** Pre-selected district (eCHIS rows carry their own district; POE does not). */
...
/**
 * Forward an NDW signal (eCHIS / POE) to a district as a call-log alert. Mirrors
 * the 6767 ForwardAlertDialog but is source-agnostic so both feeds reuse it.
 */
export function ForwardNdwAlertDialog({
	isOpen,
	onClose,
	sourceLabel,
	defaultDistrict,
			...
			<DialogContent className="sm:max-w-md">
				...
				<div className="space-y-4">
					...
					<div className="space-y-1.5">
						<Label htmlFor="ndw-forward-district">
							District <span className="text-uganda-red">*</span>
						</Label>
						<DistrictSelect
							id="ndw-forward-district"
							value={district}
					...
					<div className="space-y-1.5">
						<Label htmlFor="ndw-forward-note">
